...
void lock_pairs(void)
{
    /*dont lock if i == last && winner[1st] == loser[last]*/
    for(int i = 0; i < pair_count - 1; i++ ){
        ...
        if (pairs[pair_count].loser != pairs[0].winner ){
           // printf("Second case\n");
            locked[pairs[pair_count].winner][pairs[0].loser]++;
        }
    }
    return;
}
...
//https://submit.cs50.io/check50/4625c5914d1d66e09cba0e91d7074da09ca730d1